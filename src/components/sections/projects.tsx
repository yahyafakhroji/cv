          ...
          {RESUME_DATA.projects.map((project, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-xl border border-border bg-card p-6 hover:border-${colorClass}/50 transition-all duration-300`}
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-4 flex items-start justify-between gap-4">
                    <h3 className={`text-lg font-semibold text-${colorClass}`}>{project.title}</h3>
                    {'link' in project && project.link && (
                      <motion.a
                        href={project.link.href}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`rounded-lg border border-border bg-background/50 p-2 hover:border-${colorClass}/50 transition-colors`}
